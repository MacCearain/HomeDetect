...
class Room(object):
    '''
      Defines the Room Class - from a physical perspective
      This Class puts the XBee Radio in a Room  -- This needs refactoring for Arduino or Xbee or RPi in Room (or multiples)
