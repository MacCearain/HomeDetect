...
for CurrentPerson in People:
    for CurrentNotify in People[CurrentPerson].NotificationSubscriptions:
        #print('Lets Notify %s at %s with Power UP Email' % (CurrentPerson, People[CurrentPerson].NotificationSubscriptions[CurrentNotify]))
...
Basement = Room.Radio('Basement', basementRadioSerialNumber)

Basement.defineSensor('a1', Room.TMP36('a1'))
Basement.sensorGroup['a1'].defineMonitor('HighTemp', Room.TemperatureHighMonitor('HighTemp', 85.0))
Basement.sensorGroup['a1'].defineMonitor('LowTemp', Room.TemperatureLowMonitor('LowTemp', 60.0))

Basement.defineSensor('d02', Room.WaterSensor('d02'))
Basement.sensorGroup['d02'].defineMonitor('Water', Room.WaterWetMonitor('Water'))

Basement.defineSensor('d10', Room.MotionSensor('d10'))
Basement.sensorGroup['d10'].defineMonitor('Motion', Room.MotionMonitor('Motion'))

bedroomRadioSerialNumber = '0013A20040C04D95'
Bedroom = Room.Radio('Bedroom', bedroomRadioSerialNumber)

Bedroom.defineSensor('a1', Room.TMP36('a1'))
Bedroom.sensorGroup['a1'].defineMonitor('HighTemp', Room.TemperatureHighMonitor('HighTemp', 90.0))
Bedroom.sensorGroup['a1'].defineMonitor('LowTemp', Room.TemperatureLowMonitor('LowTemp', 60.0))

Bedroom.defineSensor('d02', Room.MotionSensor('d02'))
Bedroom.sensorGroup['d02'].defineMonitor('Motion', Room.MotionMonitor('Motion'))

Bedroom.defineSensor('d10', Room.ToggleSwitch('d10'))


garageRadioSerialNumber =   '0013A20099999999'
Garage = Room.Radio('Garage', garageRadioSerialNumber)

Garage.defineSensor('a1', Room.TMP36('a1'))
Garage.sensorGroup['a1'].defineMonitor('HighTemp', Room.TemperatureHighMonitor('HighTemp', 100.0))
Garage.sensorGroup['a1'].defineMonitor('LowTemp', Room.TemperatureLowMonitor('LowTemp', -10.0))

Garage.defineSensor('d02', Room.DoorSwitch('d02'))
Garage.sensorGroup['d02'].defineMonitor('BigDoor', Room.DoorOpenMonitor('BigDoor'))

Garage.defineSensor('d10', Room.MotionSensor('d10'))
Garage.sensorGroup['d10'].defineMonitor('Motion', Room.MotionMonitor('Motion'))
